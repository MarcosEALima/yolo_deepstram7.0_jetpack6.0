...
class_names = []
with open("lapon/labels.txt", "r") as f:
...
def main(args, requested_pgie=None, config=None, disable_probe=False):
    ...
    pgie.set_property("config-file-path", "config_infer_primary_yoloV8_lapon.txt")
    #pgie.set_property("config-file-path", "config_infer_primary_yoloV8_boituva.txt")
